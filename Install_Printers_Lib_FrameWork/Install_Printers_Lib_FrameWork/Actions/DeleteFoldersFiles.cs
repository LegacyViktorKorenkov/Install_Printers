...
namespace Install_Printers_Lib.Actions
{
    public class DeleteFoldersFiles
    {
        ...
        private void DeleteFolder()
        {
            ...
            {
                throw new Exception("Ошибка удаления папки. Проверьте правильность введенного пути.");
            }
        }
        ...
        private bool DeleteFolders()
        {
            foreach (var p in _deletePaths)
            {
                ...
                {
                    throw new Exception("Ошибка удаления папок. Проверьте правильность введенного пути.");
                }
            }
